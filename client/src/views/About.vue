<template>
	<main id="about" class="main--shrink-wide">
		<h1>About the app</h1>
		<div class="padded">
			<p>
				...
				<router-link to="">overall value</router-link> proposition. Organically
				grow the holistic world view of disruptive innovation via workplace
